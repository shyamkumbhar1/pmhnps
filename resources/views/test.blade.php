	...
	<table class="table table-bordered">
		...
		<tbody>
				...
				<tr>
					...
					<td>
						<div >
                            <a href="http://localhost:8000/admin/pmhnps/77" class="btn btn-info">Show</a>
                            <a href="http://localhost:8000/admin/pmhnps/77/edit" class="btn btn-primary">Edit</a>
                            <form method="POST" action="http://localhost:8000/admin/pmhnps/77" accept-charset="UTF-8"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="33HFVy7cxgYN3nEceJaVwcrhOrVutSAE5kvCa95B">
